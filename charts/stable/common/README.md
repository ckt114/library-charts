...
| externalSecrets | object | `{}` | Configure ExternalSecret resources for the chart here. Additional ExternalSecrets can be added by adding a dictionary key similar to the example below. |
